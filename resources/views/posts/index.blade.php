                        ...
                        <div class="mb-6 mt-2 p-3 bg-gray-200 rounded-2xl lg:transform lg:transition lg:duration-500 lg:hover:scale-105 lg:hover:shadow-2xl dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <div class="flex p-2 justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    <h2 class="text-gray-800 dark:text-white font-bold cursor-pointer">{{ $post->user ? $post->user->name : 'Usuario Desconocido' }}</h2>
                                </div>
                            ...
                            <!-- Descripcion -->
                            <div>
                                <!-- <h1 class="text-2xl mt-2 ml-4 font-bold text-gray-800 cursor-pointer dark:text-white">{{ $post->title }}</h1>
                                <p class="ml-4 mt-1 mb-2 pb-4 text-gray-700 dark:text-white">{{ $post->description }}</p> -->
                                <div>{!! $post->title !!}</div>
